...
namespace BankServer.Crud
{
    public class TransactionCrud : ACrud<Transaction>
    {
        ...
        /// <summary>
        /// Renvoi les X dernières transactions du joueur. S'il existe moins de X transaction, la liste comportera moins d'éléments
        /// </summary>
        public List<Transaction> GetLastXTransactionForPlayer(long playerId, int transactionCount)
        {
            throw new NotImplementedException();
        }
